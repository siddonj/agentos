...
export async function GET(req: NextRequest) {
  try {
    const file = readContextFile('automation/tools-registry.md')

    if (!file) {
      return NextResponse.json(
        {
          error: 'Context file not found: automation/tools-registry.md',
          hint: 'Create vault/automation/tools-registry.md in your Obsidian vault',
    ...
    return NextResponse.json({
      ...
      path: 'automation/tools-registry.md',
