...
export async function GET(req: NextRequest) {
  try {
    const file = readContextFile('business/context.md')

    if (!file) {
      return NextResponse.json(
        {
          error: 'Context file not found: business/context.md',
          hint: 'Create vault/business/context.md in your Obsidian vault',
