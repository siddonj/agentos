...
export async function GET(req: NextRequest) {
  try {
    const business = readContextFile('business/context.md')
    const agents = readContextFile('automation/agents.md')
    const tools = readContextFile('automation/tools-registry.md')
